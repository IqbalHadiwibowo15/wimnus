                            ...
                            <div class="mobile-footer px-20 py-20 border-top-light js-mobile-footer">
                                <div class="mobile-footer__number">
                                    ...
                                    <div class="text-17 fw-500 text-purple-1">
                                        <a href="tel:+6281228652309">+6281228652309</a>
                                    </div>
                                </div>

                                <div class="lh-2 mt-10">
                                    <div>Karanggayam No.RT 03, Karangbayam, Bantul, Kec. Bantul, Kabupaten Bantul,
                                        <br> Daerah Istimewa Yogyakarta 55711, Indonesia.
                                    </div>
                                    <div>
                                        <a href="mailto:dpdwimnusjateng@gmail.com">dpdwimnusjateng@gmail.com</a>
                                    </div>
                                </div>
